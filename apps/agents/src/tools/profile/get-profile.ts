...
export const getProfileTool = tool(
  ...
  },
  {
    ...
    schema: z.object({
      section: z.enum(["life", "work", "productivity", "health", "relationships", "routines", "decisionMaking", "communication", "learning", "agentPreferences", "rules"]).optional().describe("Specific profile section to retrieve (optional)"),
    }),
  }
);
