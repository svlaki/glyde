...
export const deleteGoalTool = tool(
  ...
  {
    name: "delete_goal",
    description: "Delete a goal by ID or search query.",
    schema: z.object({
      goalId: z.string().optional().nullable().describe("Goal UUID (optional)"),
      searchQuery: z.string().describe("Fuzzy search to find goal"),
    }),
  }
);
